  ...
  return (
    <section className="relative w-full overflow-hidden bg-gradient-to-br from-slate-50 via-teal-50/40 to-blue-50/40 py-20 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-9 items-center gap-14">
          {/* LEFT CONTENT */}
          <div className="col-span-5 space-y-7 animate-in fade-in slide-in-from-left-8 duration-700">
          ...
          {/* RIGHT IMAGE ONLY */}
          <div className="col-span-4 relative animate-in fade-in slide-in-from-right-8 duration-700 delay-200">
