...
const testimonials = [
  {
    text: "We worked with them for web development and local SEO, and the results were solid. The website looks modern, loads fast, and our local enquiries improved within a short time. Clear communication and no over promising.",
  ...
  {
    text: "Very happy with the web design and digital marketing support. They understood our business goals and translated that into a clean website and effective campaigns. Professional and easy to work with",
  ...
  {
    text: "Strong team for web development and SEO. The site structure, speed, and local search visibility all improved. They explain things clearly, which makes a big difference.",
  ...
  {
    text: "We engaged them for web design and digital marketing. The website is well built and the local SEO work helped us attract more relevant leads. Straightforward, honest service.",
  ...
  {
    text: "Clean web design, strong local SEO, and practical marketing advice. Very effective",
    author: "Ben Carter",
    role: "",
    company: "",
    rating: 5,
