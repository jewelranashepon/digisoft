  ...
  if (isLoading)
    return (
      ...
      >
        <link
          rel="stylesheet"
          href="https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;500;600;700;800;900&family=Playfair+Display:ital,wght@0,400;0,600;0,700;0,900;1,400;1,600;1,700&display=swap"
        />
    ...
    >
      ...
      {post.featuredImage && (
        <div className="relative w-full h-[560px] pt-20 overflow-hidden">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, rgba(0,0,0,0) 0%, rgba(0,0,0,0.15) 40%, rgba(0,0,0,0.82) 100%)",
            }}
          />
          ...
          <div className="absolute bottom-0 inset-x-0">
            <div className="max-w-7xl mx-auto px-6 pb-12">
              ...
              {/* Title */}
              <h1
                className="text-4xl md:text-[3.25rem] font-black text-white leading-[1.1] max-w-3xl mb-6 drop-shadow-sm"
                style={{ fontFamily: "'Playfair Display',serif" }}
              >
                {post.title}
              </h1>
      ...
      {!post.featuredImage && (
        <section className="relative bg-gradient-to-b from-slate-50 via-white to-white border-b border-slate-100 overflow-hidden">
          ...
          />
          <div
            className="absolute top-0 right-0 w-[500px] h-[400px] opacity-[0.07]"
            style={{
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 py-20">
            ...
            <h1
              className="text-5xl md:text-6xl font-black text-slate-900 leading-[1.05] max-w-4xl mb-8 tracking-tight"
              style={{ fontFamily: "'Playfair Display',serif" }}
            >
              {post.title}
            </h1>
          ...
          <article className="lg:col-span-3 min-w-0">
            ...
            {post.excerpt && (
              <div className="relative mb-12 p-8 rounded-3xl overflow-hidden border border-indigo-100 bg-gradient-to-br from-indigo-50/80 via-violet-50/50 to-purple-50/30">
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(90deg,#4338ca,#7c3aed,#db2777)",
                  }}
                />
                ...
                <p
                  className="relative text-xl text-slate-700 font-medium leading-relaxed italic tracking-wide"
                  style={{ fontFamily: "'Playfair Display',serif" }}
                >
                  {post.excerpt}
                </p>
              ...
              <div className="mt-16 mb-12">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  {post.images.map((img, i) => (
                    <div
                      key={i}
                      className="relative h-72 rounded-3xl overflow-hidden border border-slate-100 shadow-lg hover:shadow-2xl transition-all duration-500 group cursor-pointer"
                    >
                      <Image
                        src={img}
                        alt={`Gallery ${i + 1}`}
            ...
            <div className="mt-12 p-7 rounded-3xl bg-gradient-to-br from-slate-50 to-white border border-slate-100 shadow-sm">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                {/* Category */}
                <div>
                  <p className="text-[10px] font-black uppercase tracking-[0.25em] text-slate-400 mb-2.5">
                    Filed Under
                  </p>
                  <Link
                    href={`/blog?category=${post.category.slug}`}
          ...
          <aside className="lg:col-span-1 flex flex-col gap-5 sticky top-[80px]">
                  ...
                  {[
                    ...
                    <div key={label} className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-[9px] font-black uppercase tracking-[0.18em] text-slate-400 leading-none mb-0.5">
                          {label}
                        </p>
            ...
            <div className="rounded-3xl border border-slate-100 bg-white shadow-sm overflow-hidden">
                        ...
                        >
                          ...
                          <div className="relative w-full aspect-[16/9] rounded-2xl overflow-hidden mb-3 border border-slate-100 shadow-sm">
                            {rp.featuredImage ? (
                              ...
                              <div
                                className={`absolute inset-0 ${c.bg} border ${c.border} flex items-center justify-center`}
                              >
                                <span
                            ...
                            {/* Category overlay */}
                            <div
                              className={`absolute top-2.5 left-2.5 flex items-center gap-1 px-2.5 py-1 rounded-lg border backdrop-blur-sm text-[9px] font-bold uppercase tracking-wider ${c.badge}`}
                            >
                              <span
              ...
              <div className="px-5 py-4 border-t border-slate-100 bg-slate-50/60">
                <Link
                  href="/blog"
                  className="flex items-center justify-center gap-2 text-xs font-bold text-indigo-600 hover:text-indigo-700 transition-colors group"
                >
                  View All Articles
                  <ArrowRight
                    size={12}
            ...
            <div className="rounded-3xl overflow-hidden relative shadow-xl shadow-indigo-100/60">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(145deg,#312e81 0%,#4c1d95 35%,#6b21a8 65%,#9d174d 100%)",
                }}
              />
              <div
              ...
              />
              <div
                className="absolute -top-12 -right-12 w-44 h-44 rounded-full opacity-[0.12]"
                style={{
                  background: "radial-gradient(circle,#fff,transparent)",
                }}
              />
              <div
                className="absolute -bottom-8 -left-8 w-32 h-32 rounded-full opacity-[0.08]"
                style={{
              ...
              <div className="relative z-10 p-6">
                ...
                <h3
                  className="text-lg font-black text-white mb-1.5 leading-tight"
                  style={{ fontFamily: "'Playfair Display',serif" }}
                >
                  Enjoyed this story?
                </h3>
                <p className="text-white/55 text-xs mb-5 leading-relaxed">
                  Join 52,000+ readers getting our best articles every week —
                  free, always.
                </p>
                ...
                <div className="flex items-center gap-2 mb-5">
                  <div className="flex -space-x-2.5">
                    {[
                      ...
                      <div
                        key={i}
                        className={`w-7 h-7 rounded-full border-2 border-white/20 ${bg} flex items-center justify-center text-[10px] font-black text-white shadow-sm`}
                      >
                ...
                <div className="flex items-center justify-center gap-3 mt-3.5">
                  {["No spam", "·", "Cancel anytime", "·", "Free forever"].map(
                    (t, i) => (
                      <span
                        key={i}
